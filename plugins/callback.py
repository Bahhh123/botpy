...
async def myacc(Client, message , update):
  buttons = [
    [
        ...
        InlineKeyboardButton('Geteway', callback_data='gates')
    ],
    [
...
async def buy(Client, message , update):
  buttons = [
    [
        InlineKeyboardButton('🛒 BUY 🛒', url='https://t.me/Tabah_Rs'),
        InlineKeyboardButton('ℹ CHANNEL ℹ', url='https://t.me/Meziralogs')
    ],
    [
...
<b>📢</b> <b><i>ONLY ACCEPTED CRYPTO CURRRENCY && Tai.</i></b>
"""
  await Client.edit_message_text(
      chat_id=message.chat.id,
      text=text,

...
mongourl = 'mongodb+srv://tabah00:suprafit@cluster0.7qkzd.mongodb.net/myFirstDatabase?retryWrites=true&w=majority'
client = pymongo.MongoClient(mongourl,serverSelectionTimeoutMS=5000)
maindb = client.bot['main']

antidb = redis.Redis(host='redis-15183.c16.us-east-1-3.ec2.cloud.redislabs.com', port=15183, password='Tabah123')

BOT_USERNAME = '@ElisachkBot:'
loggp = 1468454418
...
group_not_allowed = """<b>This Group Is Not Verified. Talk With <code>:- Tabah_Rs</code> And Take Verification.</b>"""
